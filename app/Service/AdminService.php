...
class AdminService
{
    ...
    public static function auth(string $username, string $password, bool $remember)
    {
        ...
        if (null === $admin) throw new OrException($error);
        if (Admin::NOT_ACTIVE === $admin->status) throw new OrException($error2);
     ...
     * @return mixed
     */
    public static function getAdminRules(int $adminId, bool $isNew = false)
    {
